...
template<>
inline void convert(int8_t &dst, const char *string) { dst=atoi(string); }
template<>
inline void convert(uint8_t &dst, const char *string) { dst=atoi(string); }
template<>
inline void convert(int16_t &dst, const char *string) { dst=atoi(string); }
template<>
inline void convert(uint16_t &dst, const char *string) { dst=atoi(string); }
template<>
inline void convert(int32_t &dst, const char *string) { dst=atoi(string); }
template<>
inline void convert(uint32_t &dst, const char *string) { dst=atoi(string); }
template<>
inline void convert(float &dst, const char *string) { dst=(float)atof(string); }
template<>
inline void convert(double &dst, const char *string) { dst=atof(string); }
...
template<> inline std::string scanTypeString(int16_t&) { return " %d"; }
template<> inline std::string scanTypeString(int32_t&) { return " %d"; }
template<> inline std::string scanTypeString(uint16_t&) { return " %d"; }
template<> inline std::string scanTypeString(uint32_t&) { return " %d"; }
template<> inline std::string scanTypeString(float&) { return " %f"; }
template<> inline std::string scanTypeString(double&) { return " %f"; }
...
// argVariable has no default value since it is not relevant unless set
  ...
  virtual int usage(const int n)
  {
    if (n<=0)
    {
      ...
      if (!buildinfo.empty()) std::cout << " (commit #"<< buildinfo<<')';
      std::cout<<"\n\n";
